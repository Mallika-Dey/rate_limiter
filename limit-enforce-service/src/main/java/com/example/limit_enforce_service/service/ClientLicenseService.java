package com.example.limit_enforce_service.service;

import com.example.limit_enforce_service.dto.AllowedEndpointDto;
import com.example.limit_enforce_service.dto.ClientLicenseDto;
import com.example.limit_enforce_service.dto.EndpointLimitDto;
import com.example.limit_enforce_service.dto.FeaturesDto;
import com.example.limit_enforce_service.entities.AllowedEndpointEntity;
import com.example.limit_enforce_service.entities.ClientLicenseEntity;
import com.example.limit_enforce_service.entities.EndpointLimitEmbeddable;
import com.example.limit_enforce_service.repository.ClientLicenseRepository;
...
public class ClientLicenseService {
    ...
    public ClientLicenseService(ClientLicenseRepository clientLicenseRepository, KafkaTemplate<String, ClientLicenseDto> kafkaTemplate) {
